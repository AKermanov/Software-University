namespace Tree
{
    ...
    public class Tree<T> : IAbstractTree<T>
    {
        ...
        public List<List<T>> PathsWithGivenSum(int sum)
        {
            ...
            this.GetPathsWithSumSfs(this, result, currentPath, ref currentSum, sum);
        ...
        private void GetPathsWithSumSfs(Tree<T> current, 
            ...
            int wantedSum)
        {
            foreach (var child in current.Children)
            {
                ...
                this.GetPathsWithSumSfs(child, wantedPaths, currentPath, ref currentSum, wantedSum);
            }
