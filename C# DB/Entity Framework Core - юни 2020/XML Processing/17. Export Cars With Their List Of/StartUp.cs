    ...
    public class StartUp
    {
        ...
        public static string GetCarsWithTheirListOfParts(CarDealerContext context)
        {
            ...
            var cars = context
                ...
                .ThenBy(c => c.Model)
                .Select(c => new GetCarsWithTheirListOfPartsDtoNew
                {
            ...
            XmlSerializer xmlSerializer = new XmlSerializer(typeof(List<GetCarsWithTheirListOfPartsDtoNew>), new XmlRootAttribute("cars"));
