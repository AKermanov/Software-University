    ...
    public class StartUp
    {
        public static void Main()
        {
           ...
           // string result = GetTotalProfitByCategory(db);
            ...
            //var result = CountBooks(db, int.Parse(input));
        ...
        public static string GetBooksByPrice(BookShopContext context)
        {
            ...
            var bookByPrice = context
                ...
                .ToList();
            return String.Join(Environment.NewLine, bookByPrice.Select(b => $"{b.Title} - ${b.Price:f2}"));
         ;
        ...
        {
            DateTime dateVal = DateTime.ParseExact(date, "dd-MM-yyyy", null);

            var books = context
                .Books
                .Where(b => b.ReleaseDate < dateVal)
